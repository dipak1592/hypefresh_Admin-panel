...
import Logo from '../../images/logo/hypefreshlogo.png';
import LogoutModal from '../../pages/Authentication/LogoutModel';
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
                    ...
                    <React.Fragment>
                      ...
                      >
                        ...
                        <NavLink
                              to="/"
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md  font-medium text-white  duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }
                            >
                        Dashboard
              ...
              <li>
                ...
                >
                  ...
                  >
                    ...
                    />
                    <path
                      d="M8 16C5.33 16 1 17.34 1 20V22H15V20C15 17.34 10.67 16 8 16Z"
                      fill=""
                    />
                    <path
                      d="M16 16C14.67 16 12.84 16.34 11.58 16.89C12.63 17.62 13 18.29 13 20V22H23V20C23 17.34 18.67 16 16 16Z"
                      fill=""
                    />
                  </svg>
                  Users
              ...
              <li>
                ...
                >
                  ...
                  >
                    <path
                      d="M6 2C5.44772 2 5 2.44772 5 3V21C5 21.5523 5.44772 22 6 22H18C18.5523 22 19 21.5523 19 21V8.41421C19 8.01639 18.841 7.63486 18.5607 7.35455L14.6454 3.43934C14.3651 3.15903 13.9836 3 13.5858 3H6ZM13 4.41421L17.5858 9H14C13.4477 9 13 8.55228 13 8V4.41421ZM7 12H17V14H7V12ZM7 16H17V18H7V16Z"
                      fill=""
                    />
                  </svg> */}
                  <svg
